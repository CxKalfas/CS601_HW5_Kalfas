async function getDegrees(url) {
  ...
  await fetch(url)
    ...
    .then((data) =>
      ...
      document.write(
        `My second degree was a ${data.data[1].degrees.masters.data.type} from ${data.data[1].degrees.masters.data.institution} in ${data.data[1].degrees.masters.data.date}`
      )
    );
}
